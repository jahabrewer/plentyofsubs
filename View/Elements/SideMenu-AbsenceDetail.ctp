<div id="sidePanel">
  ...
  <ul id="sideNav">
    ...
    echo $this->Html->link('<li>'.$this->Html->image('icons/retract_application.png').'Retract Application</li>', array('controller' => 'absences', 'action' => 'retract', $absence['Absence']['id']), array('escape' => false));
